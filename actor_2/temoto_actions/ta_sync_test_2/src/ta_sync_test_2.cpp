...
#include "ta_sync_test_2/temoto_action.h"
#include <chrono>
#include <thread>

/* 
 * ACTION IMPLEMENTATION of TaSyncTest2 
 */
class TaSyncTest2 : public TemotoAction
{
public:
...
CLASS_LOADER_REGISTER_CLASS(TaSyncTest2, ActionBase);
